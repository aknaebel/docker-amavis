...
#RUN echo "deb http://fr.archive.ubuntu.com/ubuntu/ focal main restricted universe multiverse" >> /etc/apt/sources.list \
...
# && echo "deb http://fr.archive.ubuntu.com/ubuntu/ focal-proposed main restricted universe multiverse" >> /etc/apt/sources.list \
